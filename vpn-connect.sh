...
pwd=`pwd`
version="0.5"
certs="FreeVPN.me-OpenVPN-Bundle-October-20#!/bin/bash
...
pwd=`pwd`
version="0.5.2"
certs="FreeVPN.me-OpenVPN-Bundle-January-2020.zip"
...
usage()
{
	...
	echo -e "\t-f \tTemporary directory to use. Default is /dev/shm or /tmp"
	echo -e "\t-h \thelp"
	exit 0
}
